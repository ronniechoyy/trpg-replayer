...
function Text_box({ text_appear_state, texts, channel, character, color, onClick}) {
  const text_state = useState('');
  useEffect(() => {
    //if (texts == undefined) { return }
    console.log('Text_box mounted',texts)
  ...
  return(
    <div className="Text_box absolute bottom-[70px] left-[50%] flex flex-col gap-[15px] overflow-hidden
        translate-x-[-50%] bg-[#222] p-[20px] rounded-[5px] shadow-lg min-h-[150px] w-[90%]" onClick={onClick}>
...
function Chat_container({ text_appear_state_change, text_auto_play, texts, channel, character, color }) {
  ...
  return (
    <div className="Chat_container w-[90%] flex flex-col justify-center">
      ...
      <Text_box text_appear_state={text_appear_state} texts={texts} channel={channel} character={character} color={color} onClick={()=>{
...
function RPG_player({log_json = [], current_index}) {
  ...
  useEffect(() => {
    console.log('RPG_player mounted', log_json[text_index[0]]?.message??'')
    async function text_appear(){
      if (text_appear_state[0] === 1) {
        console.log('text_appear_state changed to 1')
        if (text_auto_play[0] == 1) {
      ...
      <Chat_container 
        ...
        text_appear_state_change={(v)=>{
          if(v==1){
            ...
            console.log('text_appear_state changed to 0')
          }
        }} />
    </div>
  );
